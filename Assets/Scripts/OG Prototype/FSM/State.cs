...
public abstract class State
{
    ...
    public virtual void OnEnter(StateMachine _stateMachine) //called at the beginning to set initial variables
    {
        stateMachine = _stateMachine;
    }


    public virtual void OnUpdate()  //called every frame to update the state
    {
        time += Time.deltaTime;
    }
    ...
    public virtual void OnExit() //clean up any data 
    {
